...
| `neighborhood_info_study.py` | **quand l'info du voisinage aide** (S11-S12 : chevauchement + densité / structure) — MLP vs GCN (k-NN, rayon, max, **somme/GIN**) vs info voisinage en feature, en **transductif** | `neighborhood_info.png` |
